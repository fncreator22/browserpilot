...
const RUNTIME_STAGES = [
  {
    ...
    desc: "User submits natural language goal. API validates schema with Zod, commits pending record via Prisma ORM, and streams real-time execution status and telemetry updates.",
    tag: "POST /api/jobs → Live Sync",
  ...
  },
  {
    ...
    title: "Gemini 2.5 + Playwright",
    desc: "Gemini 2.5 Flash Planner reasons over accessibility DOM trees and dispatches actions from 8 deterministic tools in an isolated incognito browser context.",
