...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://js.puter.com https://api.puter.com wss://api.puter.com https://api.razorpay.com https://generativelanguage.googleapis.com",
...
const nextConfig: NextConfig = {
  async headers() {
    return [
      ...
      {
        source: "/api/ops-sec-7f9c2d1b8e4a/:path*",
        headers: privateApiHeaders,
      },
      {
