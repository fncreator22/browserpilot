...
export async function runDbPersistenceIntegrationTests() {
  console.log("=================================================");
  ...
  console.log("\n✅ SUCCESS: All Prisma PostgreSQL/SQLite/Turso data persisted and survived process restart!\n");
}

if (require.main === module || !process.env.IS_TEST_HARNESS) {
  runDbPersistenceIntegrationTests().catch((err) => {
